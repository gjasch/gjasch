...
const AI_MAX_ERROR_AT_MAX_DISTANCE = PADDLE_HEIGHT * 0.35; // Max random error in Y prediction when ball is furthest
...
const AI_REACTION_INTERVAL = 350; // Milliseconds between AI reaction/prediction updates
